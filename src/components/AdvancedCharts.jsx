...
export function WaterfallChart({
  ...
  return (
    <div className={`rounded-xl border p-6 shadow-shadow-md ${dark ? "bg-slate-800 border-slate-700" : "bg-white border-slate-200"} ${className}`}>
...
export function Heatmap({
  ...
  return (
    <div className={`rounded-xl border p-6 shadow-shadow-md ${dark ? "bg-slate-800 border-slate-700" : "bg-white border-slate-200"} ${className} overflow-x-auto`}>
      {title && (
