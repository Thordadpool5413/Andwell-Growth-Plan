...
const services = {
  ...
  Hospice: { color: "#9333ea", role: "Future expansion line", unit: "hospice admissions", reimbursement: 14723, margin: 0.22, conversion: 0.75, demandRate: 0.06, disclaimer: "Hospice values are modeled from CMS 2022 PUF; not yet validated against Andwell actuals." },
};
